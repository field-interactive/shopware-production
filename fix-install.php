...
require_once '/var/www/application/vendor/autoload.php';
...
const DATABASE_URL = "mysql://application:application@mysql:3306/application";
const INSTALL_CURRENCY= "EUR";
const INSTALL_LOCALE= "de-DE";
...
$fixer->setDefaultCurrency(INSTALL_CURRENCY);
$fixer->setDefaultLanguage(INSTALL_LOCALE);
